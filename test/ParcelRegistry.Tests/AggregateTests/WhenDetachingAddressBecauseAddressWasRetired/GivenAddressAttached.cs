namespace ParcelRegistry.Tests.AggregateTests.WhenDetachingAddressBecauseAddressWasRetired
{
    ...
    public class GivenAddressAttached : ParcelRegistryTest
    {
        ...
        public void ThenAddressWasDetachedBecauseAddressWasRemoved()
        {
            ...
            Assert(new Scenario()
                ...
                .Then(new Fact(new ParcelStreamId(command.ParcelId),
                    new ParcelAddressWasDetachedBecauseAddressWasRetired(command.ParcelId, command.AddressPersistentLocalId))));
        }
        ...
        public void StateCheck()
        {
            ...
            var parcelAddressWasDetachedV2 = new ParcelAddressWasDetachedBecauseAddressWasRetired(Fixture.Create<ParcelId>(), addressPersistentLocalId);
