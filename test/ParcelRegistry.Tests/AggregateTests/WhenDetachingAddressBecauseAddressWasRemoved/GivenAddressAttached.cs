namespace ParcelRegistry.Tests.AggregateTests.WhenDetachingAddressBecauseAddressWasRemoved
{
    ...
    public class GivenAddressAttached : ParcelRegistryTest
    {
        ...
        public void ThenAddressWasDetachedBecauseAddressWasRemoved()
        {
            ...
            Assert(new Scenario()
                ...
                .Then(new Fact(new ParcelStreamId(command.ParcelId),
                    new ParcelAddressWasDetachedBecauseAddressWasRemoved(command.ParcelId, command.AddressPersistentLocalId))));
        }
        ...
        public void StateCheck()
        {
            ...
            var parcelAddressWasDetachedV2 = new ParcelAddressWasDetachedBecauseAddressWasRemoved(Fixture.Create<ParcelId>(), addressPersistentLocalId);
