namespace ParcelRegistry.Tests.ProjectionTests
{
    using System;
    ...
    public abstract class KafkaProjectionTest<TContext, TProjection> : ParcelRegistryTest
        where TProjection : ConnectedProjection<TContext>
    {
        ...
        protected async Task Then(Func<TContext, Task> assertions)
        {
