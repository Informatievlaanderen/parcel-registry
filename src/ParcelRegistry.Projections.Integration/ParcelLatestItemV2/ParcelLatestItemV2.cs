namespace ParcelRegistry.Projections.Integration.ParcelLatestItemV2
{
    ...
    public sealed class ParcelLatestItemV2
    {
        ...
        protected ParcelLatestItemV2()
        { }
    }

    public sealed class ParcelLatestItemV2Configuration : IEntityTypeConfiguration<ParcelLatestItemV2>
    {
        public void Configure(EntityTypeBuilder<ParcelLatestItemV2> builder)
        {
            builder
                .ToTable("parcel_latest_items_v2", Schema.Integration)
            ...
            builder.Property(ParcelLatestItemV2.VersionTimestampBackingPropertyName).HasColumnName("version_timestamp");
