namespace ParcelRegistry.Api.Legacy.Parcel.Detail
{
    ...
    public class ParcelDetailV1Handler : IRequestHandler<ParcelDetailRequest, ParcelResponseWithEtag>
    {
        private readonly LegacyContext _context;
        private readonly SyndicationContext _syndicationContext;
        private readonly IOptions<ResponseOptions> _responseOptions;

        public ParcelDetailV1Handler(
        ...
        public async Task<ParcelResponseWithEtag> Handle(ParcelDetailRequest request, CancellationToken cancellationToken)
        {
            ...
            return new ParcelResponseWithEtag(new ParcelDetailResponse(
