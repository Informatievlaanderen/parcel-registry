namespace ParcelRegistry.Parcel.Events
{
    ...
    [EventName(EventName)]
    [EventDescription("Het adres werd gekoppeld aan het perceel door heradressering.")]
    public sealed class ParcelAddressWasAttachedBecauseAddressWasReaddressed : IParcelEvent
    {
        public const string EventName = "ParcelAddressWasAttachedBecauseAddressWasReaddressed"; // BE CAREFUL CHANGING THIS!!
        ...
        public ParcelAddressWasAttachedBecauseAddressWasReaddressed(
            ParcelId parcelId,
        ...
        [JsonConstructor]
        private ParcelAddressWasAttachedBecauseAddressWasReaddressed(
            Guid parcelId,
            string caPaKey,
