namespace ParcelRegistry.Parcel.Events
{
    ...
    [EventName(EventName)]
    [EventDescription("Er werd een adres ontkoppeld aan het perceel.")]
    public sealed class ParcelAddressWasDetachedV2 : IParcelEvent
    {
        public const string EventName = "ParcelAddressWasDetachedV2"; // BE CAREFUL CHANGING THIS!!
        ...
        [JsonConstructor]
        private ParcelAddressWasDetachedV2(
            Guid parcelId,
