...
namespace ParcelRegistry.Projections.Legacy.Migrations
{
    ...
    [Migration("20240607120641_DeleteOldRenameV2WithCount")]
    partial class DeleteOldRenameV2WithCount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ParcelRegistry.Projections.Legacy.ParcelDetail.ParcelDetailAddress", b =>
                {
                    ...
                    b.ToTable("ParcelDetailAddresses", "ParcelRegistryLegacy");
                });

            modelBuilder.Entity("ParcelRegistry.Projections.Legacy.ParcelDetailV2ListViewCount", b =>
                {
