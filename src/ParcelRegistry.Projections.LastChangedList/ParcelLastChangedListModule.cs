namespace ParcelRegistry.Projections.LastChangedList
{
    ...
    public class ParcelLastChangedListModule : LastChangedListModule
    {
        public ParcelLastChangedListModule(
        ...
        {
            var logger = loggerFactory.CreateLogger<ParcelLastChangedListModule>();
