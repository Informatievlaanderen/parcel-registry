namespace ParcelRegistry.Api.BackOffice
{
    ...
    public partial class ParcelController : ApiController
    {
        private readonly IMediator _mediator;
        private readonly TicketingOptions _ticketingOptions;

        public ParcelController(IMediator mediator, IOptions<TicketingOptions> ticketingOptions)
        {
            _mediator = mediator;
        ...
        {
            var userId = User.FindFirst("urn:be:vlaanderen:parcelregistry:acmid")?.Value;
