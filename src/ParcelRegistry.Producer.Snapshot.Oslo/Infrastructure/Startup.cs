namespace ParcelRegistry.Producer.Snapshot.Oslo.Infrastructure
{
    ...
    public class Startup
    {
        ...
        private static string GetApiLeadingText(ApiVersionDescription description)
            => $"Momenteel leest u de documentatie voor versie {description.ApiVersion} van de Basisregisters Vlaanderen Parcel Registry Producer Snapshot Oslo API{string.Format(description.IsDeprecated ? ", **deze API versie is niet meer ondersteund * *." : ".")}";
    }
}
