namespace ParcelRegistry.Projections.LastChangedList.Console.Infrastructure
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Log.Information("Initializing ParcelRegistry.Projections.LastChangedList.Console");
            ...
            Log.Information("Starting ParcelRegistry.Projections.LastChangedList.Console");
