namespace ParcelRegistry.Producer.Infrastructure
{
    using System;
    using System.Linq;
    ...
    public class Startup
    {
            ...
            app
                ...
                .UseDefaultForApi(new StartupUseOptions
                {
                    ...
                    Api =
                    {
                        ...
                        CSharpClientOptions =
                        {
                            ClassName = "ParcelRegistryProducer",
        ...
        private static string GetApiLeadingText(ApiVersionDescription description)
            => $"Momenteel leest u de documentatie voor versie {description.ApiVersion} van de Basisregisters Vlaanderen Parcel Registry Producer API{string.Format(description.IsDeprecated ? ", **deze API versie is niet meer ondersteund * *." : ".")}";
    }
}
